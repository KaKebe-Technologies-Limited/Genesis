...
(function () {
  ...
  if (lightbox && galleryItems.length) {
    ...
    function openLightbox(idx) {
      const visible = Array.from(galleryItems).filter(i => i.offsetParent !== null);
      currentIdx = idx;
  ...
  if (form) {
    form.addEventListener('submit', e => {
      ...
      setTimeout(() => {
        showNotification(`Thank you! Your message has been received. We'll be in touch soon.', 'success`);
        form.reset();
